...
int js_module_register()
{
    ...
    sc->addRegisterCallback(register_jsb_pomelo);
    sc->addRegisterCallback(register_all_cocos2dx_custom_core);
    sc->addRegisterCallback(register_all_cocos2dx_custom_core_manual);
