...
bool js_cocos2dx_ui_Button_setSoundEffectFile(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    JS::RootedObject obj(cx, args.thisv().toObjectOrNull());
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::ui::Button* cobj = (cocos2d::ui::Button *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_ui_Button_setSoundEffectFile : Invalid Native Object");
    if (argc == 1) {
        const char* arg0;
        std::string arg0_tmp; ok &= jsval_to_std_string(cx, args.get(0), &arg0_tmp); arg0 = arg0_tmp.c_str();
        JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_ui_Button_setSoundEffectFile : Error processing arguments");
        cobj->setSoundEffectFile(arg0);
        args.rval().setUndefined();
        return true;
    }

    JS_ReportError(cx, "js_cocos2dx_ui_Button_setSoundEffectFile : wrong number of arguments: %d, was expecting %d", argc, 1);
    return false;
}
...
bool js_cocos2dx_ui_Button_setDefaultSoundEffectFile(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
        const char* arg0;
        std::string arg0_tmp; ok &= jsval_to_std_string(cx, args.get(0), &arg0_tmp); arg0 = arg0_tmp.c_str();
        JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_ui_Button_setDefaultSoundEffectFile : Error processing arguments");
        cocos2d::ui::Button::setDefaultSoundEffectFile(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportError(cx, "js_cocos2dx_ui_Button_setDefaultSoundEffectFile : wrong number of arguments");
    return false;
}
...
bool js_cocos2dx_ui_Button_setSoundEffectFunc(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    if (argc == 1) {
        ...
        do {
		    if(JS_TypeOfValue(cx, args.get(0)) == JSTYPE_FUNCTION)
		    {
		        ...
		        auto lambda = [=](const char* larg0) -> void {
		            ...
		            do {
		            if (larg0) {
		                js_proxy_t *jsProxy = js_get_or_create_proxy<char>(cx, (char*)larg0);
		                largv[0] = OBJECT_TO_JSVAL(jsProxy->obj);
		            } else {
		                largv[0] = JSVAL_NULL;
		            }
		...
		;
        JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_ui_Button_setSoundEffectFunc : Error processing arguments");
        cocos2d::ui::Button::setSoundEffectFunc(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportError(cx, "js_cocos2dx_ui_Button_setSoundEffectFunc : wrong number of arguments");
    return false;
}
...
void js_register_cocos2dx_ui_Button(JSContext *cx, JS::HandleObject global) {
    ...
    static JSFunctionSpec funcs[] = {
        ...
        JS_FN("setSoundEffectFile", js_cocos2dx_ui_Button_setSoundEffectFile, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
    ...
    static JSFunctionSpec st_funcs[] = {
        JS_FN("setDefaultSoundEffectFile", js_cocos2dx_ui_Button_setDefaultSoundEffectFile, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        ...
        JS_FN("setSoundEffectFunc", js_cocos2dx_ui_Button_setSoundEffectFunc, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FS_END
    };
