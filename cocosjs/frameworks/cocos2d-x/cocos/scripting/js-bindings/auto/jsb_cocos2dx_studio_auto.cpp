...
bool js_cocos2dx_studio_BoneNode_getChildBones(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS::RootedObject obj(cx);
    cocostudio::timeline::BoneNode* cobj = NULL;
    obj = args.thisv().toObjectOrNull();
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cobj = (cocostudio::timeline::BoneNode *)(proxy ? proxy->ptr : NULL);
...
bool js_cocos2dx_studio_SkeletonNode_changeSkins(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS::RootedObject obj(cx);
    cocostudio::timeline::SkeletonNode* cobj = NULL;
    obj = args.thisv().toObjectOrNull();
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cobj = (cocostudio::timeline::SkeletonNode *)(proxy ? proxy->ptr : NULL);
...
bool js_cocos2dx_studio_CSLoader_bindCallback(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::CSLoader* cobj = (cocos2d::CSLoader *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_studio_CSLoader_bindCallback : Invalid Native Object");
    if (argc == 4) {
        std::string arg0;
        std::string arg1;
        ...
        do {
            ...
            JSObject *tmpObj = args.get(2).toObjectOrNull();
            jsProxy = jsb_get_js_proxy(tmpObj);
            arg2 = (cocos2d::ui::Widget*)(jsProxy ? jsProxy->ptr : NULL);
            JSB_PRECONDITION2( arg2, cx, false, "Invalid Native Object");
        } while (0);
        do {
        ...
        JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_studio_CSLoader_bindCallback : Error processing arguments");
    ...
    JS_ReportError(cx, "js_cocos2dx_studio_CSLoader_bindCallback : wrong number of arguments: %d, was expecting %d", argc, 4);
    return false;
}
...
void js_register_cocos2dx_studio_CSLoader(JSContext *cx, JS::HandleObject global) {
...
void register_all_cocos2dx_studio(JSContext* cx, JS::HandleObject obj) {
    ...
    js_register_cocos2dx_studio_CSLoader(cx, ns);
