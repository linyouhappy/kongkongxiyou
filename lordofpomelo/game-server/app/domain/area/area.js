...
Instance.prototype.enterArea = function(player) {
  player.died = false;
  this.timer.abortAllAction(player.entityId);
...
Instance.prototype.getBossGenTime = function() {
  var bossEntity=this.getEntity(this.bossEntityId);
  if (bossEntity) {
    return 0;
  }else{
    return this.nextBossGenTime;
  }
};
