...
//               item.id=itemId;
//               item.kindId=kindId;
//               self.chatService.addChatItem(item);
//             }
//           });
//         }
...
ChannelHandler.prototype.getChatItem = function(msg, session, next) {
  var chatItem = this.chatService.getChatItem(msg.itemId) || {};
  next(null, chatItem);
};
...
ChannelHandler.prototype.send = function(msg, session, next) {
  ...
  this.chatService.findItem(chatContent,session);
